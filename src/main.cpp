...
#if defined(NDEBUG)
# error "GENESISCOIN cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x18763f82e6e1a999d63a62f48aa0c328290f656e69ab729440f8c0e26c060046");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // GENESISCOIN: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = 5000 * COIN;
     ...
     if(nHeight == 1)
     {
        nSubsidy = 2010309 * COIN;
     }

    // Subsidy is cut in half every 6500 blocks
    nSubsidy >>= (nHeight / 6500);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 80 * 60;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x18763f82e6e1a999d63a62f48aa0c328290f656e69ab729440f8c0e26c060046");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1434998049, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "22/Jun/2015 GENESISCOIN 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xd4646f0e986fdb70de0707b8706fc0f5e8a01050a2eb4214c373b1d0c5527826"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // GENESISCOIN: increase each by adding 2 to bitcoin's value.
